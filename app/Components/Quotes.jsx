      ...
      {!isRun ? (
        <>
          ...
          <button
            ...
            className="cursor-pointer bg-blue-600 dark:bg-blue-700 text-white dark:text-gray-100 font-bold px-6 py-2 rounded-full  hover:bg-blue-700 dark:hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-600 transition-all"
          >
            Add Quote
          </button>
        </>
